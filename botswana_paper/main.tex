...
The adaptive gain is cheap: relative to static robust, ARO-ADR removes about 48\% of the remaining unmet demand for a procurement increase of only about 1.5\%, because affine recourse lets shipments respond to realized demand rather than committing in advance.
...
The extra units it buys are not idle stock: over the horizon it procures $37{,}499$ more units than static robust and meets $37{,}341$ more units of demand, a conversion of $99.6\%$.
The total objective under ARO-ADR is lowest, about 33\% below static robust and over 75\% below deterministic, since the shortage penalty dominates.
