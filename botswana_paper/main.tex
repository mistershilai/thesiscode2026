...
\begin{figure}[htbp]
    ...
    \caption{Gaborone proof-of-concept: average unmet antimicrobial demand under the three policies, with one standard error across the $12$ realizations. Adaptive recourse (ARO-ADR) achieves the lowest unmet demand.}
    \label{fig:gaborone}
\end{figure}
