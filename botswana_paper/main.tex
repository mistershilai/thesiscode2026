...
\begin{figure}[htbp]
    ...
    \caption{Gaborone proof-of-concept: average unmet antimicrobial demand under the three policies, with $95\%$ confidence intervals across the $12$ demand realizations. The intervals are disjoint, so the ordering is not an artefact of which demand paths were drawn.}
    \label{fig:gaborone}
\end{figure}
