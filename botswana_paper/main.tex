...
The per-period net benefit of ARO-ADR over static robust, shortage cost avoided less the extra procurement it buys, is positive in every period.
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Economics of adaptive recourse in the Gaborone proof-of-concept. Transport cost is similar across policies (a), the per-period net benefit of ARO-ADR over static robust is positive throughout (b), and ARO-ADR attains the lowest total objective (c).}
    \label{fig:gabcost}
\end{figure}
