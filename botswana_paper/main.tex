...
Fitting the survey counts yields $\hat\kappa \approx 2$, and a method-of-moments estimate gives $\hat\kappa \approx 4$; both indicate substantial overdispersion.
Because they rest on one survey, we treat $\kappa$ as uncertain and sweep it in \Sec\ref{sec:results}.
The headline runs use $\kappa = 10$, a less variable regime than either estimate, and Figure~\ref{fig:kappa} shows the advantage of adaptivity grows as $\kappa$ falls, so this choice understates it.
