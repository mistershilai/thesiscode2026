...
\begin{figure}[htbp]
    ...
    \caption{Gaborone proof-of-concept: average unmet antimicrobial demand under the three policies. Bars show $95\%$ confidence intervals across the $12$ demand realizations. Adaptive recourse (ARO-ADR) achieves the lowest unmet demand.}
    \label{fig:gaborone}
\end{figure}
