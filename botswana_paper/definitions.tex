...
% Draft notes. main.tex defines this already; providecommand keeps the
% e-companion able to use it without clashing.
\providecommand{\mynote}[1]{\textcolor{blue}{\textbf{[note: #1]}}}
