...
Kweneng is a persistent transport-cost outlier, absorbing about a third of national transport cost.
The driver is dispersion rather than area: Kweneng carries almost as much volume as Greater Gaborone but spread over settlements far from its depot, giving it roughly five times Gaborone's transport cost per unit shipped.
Area alone explains little, since the largest districts by area (Ghanzi, Kgalagadi, Chobe) have negligible transport cost because they have little demand to move.
