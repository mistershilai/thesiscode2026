...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Realized unmet demand over two seasonal cycles. Supplying the seasonally-adjusted mean lets all policies pre-position ahead of peaks; ARO-ADR benefits most.}
    \label{fig:seasonal}
\end{figure}
