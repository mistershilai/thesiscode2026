      ...
      <div className="login-bottom">
        <div className="login-partners">
          ...
          <a href="https://achap.org/" target="_blank" rel="noopener noreferrer">
            <img src="/logos/achap.png" alt="ACHAP" className="login-partner-logo" />
          </a>
          <a href="https://chw.princeton.edu/" target="_blank" rel="noopener noreferrer">
            <img src="/logos/chw.png" alt="Princeton Center for Health and Wellbeing" className="login-partner-logo" />
          </a>
          <a href="https://globalhealth.princeton.edu/" target="_blank" rel="noopener noreferrer">
            <img src="/logos/ghp.png" alt="Princeton Global Health Program" className="login-partner-logo" />
          </a>
